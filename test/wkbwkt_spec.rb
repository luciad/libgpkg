...
describe 'WKBFromText' do
  ...
  it 'should parse empty circularstring correctly' do
    expect(query(AS_WKB, 'CircularString empty')).to have_result '010800000000000000'
  end

  it 'should parse XY CircularStrings correctly' do
    expect(query(AS_WKB, 'CircularString(1 2, 3 4, 5 6)')).to have_result '010800000003000000000000000000f03f00000000000000400000000000000840000000000000104000000000000014400000000000001840'
  end

  it 'should parse XYZ CircularStrings correctly' do
    expect(query(AS_WKB, 'CircularString Z (1 2 1, 3 4 2, 5 6 3)' )) .to have_result '01f003000003000000000000000000f03f0000000000000040000000000000f03f000000000000084000000000000010400000000000000040000000000000144000000000000018400000000000000840'
  end

  it 'should parse XYM CircularStrings correctlly' do
    expect(query(AS_WKB, 'CircularString M (1 2 1, 3 4 2, 5 6 3)' )) .to have_result '01d807000003000000000000000000f03f0000000000000040000000000000f03f000000000000084000000000000010400000000000000040000000000000144000000000000018400000000000000840'
  end

  it 'should parse XYZM CircularStrings correctlly' do
    expect(query(AS_WKB, 'CircularString ZM (1 2 1 2, 3 4 2 3, 5 6 3 4)' )) .to have_result '01c00b000003000000000000000000f03f0000000000000040000000000000f03f000000000000004000000000000008400000000000001040000000000000004000000000000008400000000000001440000000000000184000000000000008400000000000001040'
  end

  it 'should parse empty compoundcurves correctly' do
    expect(query(AS_WKB, 'CompoundCurve empty')).to have_result '010900000000000000'
  end

  it 'should raise error on incorrect line string modifier in compoundcurve' do
    expect(query(AS_WKB, 'CompoundCurve(linestring(1 0, 1 0, 2 0)')).to raise_sql_error
  end

  it 'should parse XY compoundcurves correctly' do
    expect(query(AS_WKB, 'CompoundCurve((0 0, 2 2, 4 3), circularstring(1 2, 3 4, 5 6))')).to have_result '010900000002000000010200000003000000000000000000000000000000000000000000000000000040000000000000004000000000000010400000000000000840010800000003000000000000000000f03f00000000000000400000000000000840000000000000104000000000000014400000000000001840'
  end
  ...
  it 'should parse XYZ compoundcurves correctly' do
    expect(query(AS_WKB, 'CompoundCurve Z((0 0 1, 2 2 2, 4 3 3), circularstring z(1 2 1, 3 4 2, 5 6 3))')).to have_result ''
  end

  it 'should raise an error if child dimensions are not the same' do
    expect(query(AS_WKB, 'CompoundCurve Z((0 0 1, 2 2 2, 4 3 3), circularstring (1 2 1, 3 4 2, 5 6 3))')).to raise_sql_error
  end

  it 'should raise an error if child dimensions are not the same' do
    expect(query(AS_WKB, 'CompoundCurve Z((0 0 , 2 2 , 4 3), circularstring z(1 2 1, 3 4 2, 5 6 3))')).to raise_sql_error
  end

  it 'should parse XYM compoundcurve correctly' do
    expect(query(AS_WKB, 'CompoundCurve M((0 0 1, 2 2 2, 4 3 3), circularstring M(1 2 1, 3 4 2, 5 6 3))')).to have_result ''
  end

  it 'should raise an error if child dimensions are not the same' do
    expect(query(AS_WKB, 'CompoundCurve M((0 0 1, 2 2 2, 4 3 3), circularstring Z(1 2 1, 3 4 2, 5 6 3))')).to raise_sql_error
  end

  it 'should parse XYZM compoundcurve correctly' do
    expect(query(AS_WKB, 'CompoundCurve ZM((0 0 1 5, 2 2 2 6, 4 3 3 7), circularstring ZM(1 2 1 5, 3 4 2 6, 5 6 3 7))')).to have_result ''
  end

  it 'should raise an error if child dimensions are not the same' do
    expect(query(AS_WKB, 'CompoundCurve ZM((0 0 1 5, 2 2 2 6, 4 3 3 7), circularstring Z(1 2 1, 3 4 2, 5 6 7))')).to raise_sql_error
  end

  it 'should parse an empty curvepolygon correctly' do
    expect(query(AS_WKB, 'curvepolygon empty')).to have_result '010a00000000000000'
  end

  it 'should parse XY curvepolygon correctly' do
    expect(query(AS_WKB, 'curvepolygon(CompoundCurve ((0 0 , 2 2 , 4 3), circularstring (1 2 , 3 4 , 5 6 )), (2 3, 4 5, 0 0), circularstring (1 2 , 3 4 , 10 10 ))')).to have_result ''
  end

  it 'should raise an error if child dimensions are not the same' do
    expect(query(AS_WKB, 'curvepolygon z(CompoundCurve((0 0, 2 2 , 4 2), circularstring z(1 2 3, 3 4 3, 5 6 7)))')).to raise_sql_error
  end

  it 'should parse XYZ curvepolygon correctly' do
    expect(query(AS_WKB, 'curvepolygon z(CompoundCurve Z((0 0 1, 2 2 2, 4 3 2), circularstring z(1 2 3, 3 4 3, 5 6 7)))')).to have_result ''
  end

  it 'should parse XYM curvepolygon correctly' do
    expect(query(AS_WKB, 'curvepolygon M(CompoundCurve M((0 0 1, 2 2 2, 4 3 2), circularstring M(1 2 3, 3 4 3, 5 6 7)))')).to have_result ''
  end

  it  'should parse XYZM curvepolygon correctly' do
    expect(query(AS_WKB, 'curvepolygon ZM(CompoundCurve ZM((0 0 1 3, 2 2 2 5, 4 3 2 6), circularstring ZM(1 2 3 5, 3 4 3 8, 5 6 7 9)))')).to have_result ''
  end
end
...
describe 'GeomFromWKB' do
  FROM_WKB = 'SELECT lower(hex(GeomFromWKB(WKBFromText(?), -1)))'

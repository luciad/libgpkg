...
module WKBHelpers
  def wkb_for(wkt)
    result_of('SELECT lower(hex(WKBFromText(?)))', wkt)
  end
end
...
describe 'WKBFromText' do
  ...
  it 'should parse XYZ points correctly' do
    expect(wkb_for('Point Z(1 2 3)')).to eq('01e9030000000000000000f03f00000000000000400000000000000840')
  end

  it 'should parse XYM points correctly' do
    expect(wkb_for('Point M(1 2 3)')).to eq('01d1070000000000000000f03f00000000000000400000000000000840')
  end

  it 'should parse XYZM points correctly' do
    expect(wkb_for('Point ZM(1 2 3 4)')).to eq('01b90b0000000000000000f03f000000000000004000000000000008400000000000001040')
  end

  it 'should parse XY line strings correctly' do
    expect(wkb_for('LineString(1 2, 3 4)')).to eq('010200000002000000000000000000f03f000000000000004000000000000008400000000000001040')
  end

  it 'should parse XYZ line strings correctly' do
    expect(wkb_for('LineString Z(1 2 3, 4 5 6)')).to eq('01ea03000002000000000000000000f03f00000000000000400000000000000840000000000000104000000000000014400000000000001840')
  end

  it 'should parse XYM line strings correctly' do
    expect(wkb_for('LineString M(1 2 3, 4 5 6)')).to eq('01d207000002000000000000000000f03f00000000000000400000000000000840000000000000104000000000000014400000000000001840')
  end
